...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    public NiftyDialogBuilder setTopPanelBackground(int color){
    	mLinearLayoutTopView.setBackgroundColor(color);
    	return this;
    }
    
    public NiftyDialogBuilder setParentPanelBackground(int color){
